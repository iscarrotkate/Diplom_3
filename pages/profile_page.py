...
class ProfilePage(BasePage):
    ...
    NAME_INPUT = "//label[contains(text(),'Имя')]/following-sibling::input"  # Поле для ввода имени на странице личного кабинета
    LOGIN_INPUT = "//label[contains(text(),'Логин')]/following-sibling::input"  # Поле для ввода логина/email на странице личного кабинета
