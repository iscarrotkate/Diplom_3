...
class LoginPage(BasePage):
    ...
    EMAIL_INPUT = "//input[@name='name']"  # Поле для ввода логина/email на странице авторизации
    PASSWORD_INPUT = "//input[@name='Пароль']"  # Поле для ввода пароля на странице авторизации
