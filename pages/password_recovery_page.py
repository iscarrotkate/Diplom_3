...
class PasswordRecoveryPage(BasePage):
    ...
    HEADER = "//h2[contains(text(),'Восстановление пароля')]"  # Заголовок страницы восстановления пароля
    EMAIL_INPUT = "//input[@name='name']"  # Поле для ввода email на странице восстановления пароля
    RECOVER_BUTTON = "//button[contains(text(),'Восстановить')]"  # Кнопка "Восстановить" на странице восстановления пароля
    LOGIN_LINK = "//a[contains(text(),'Войти')]"  # Кнопка "Войти" на странице восстановления пароля
